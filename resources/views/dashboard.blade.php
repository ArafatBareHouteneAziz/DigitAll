            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-400">currently active</span>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $completedProjects ?? 0 }}</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <span class="text-sm text-purple-600 dark:text-purple-400 font-medium">{{ $completedProjects ?? 0 }}</span>
                        <span class="text-sm text-gray-500 dark:text-gray-400">successfully delivered</span>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">${{ number_format($totalRevenue ?? 0, 2) }}</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <span class="text-sm {{ ($revenueGrowth ?? 0) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }} font-medium">
