...
<div class="min-h-screen bg-gradient-to-br from-neutral-50 to-primary-50 flex items-center justify-center">
    <div class="container mx-auto px-6 text-center">
        ...
        <div class="mb-8">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">Server Error</h2>
        ...
        <div class="bg-white rounded-2xl shadow-soft border border-neutral-100 p-8 max-w-2xl mx-auto">
            <h3 class="text-2xl font-bold text-neutral-900 mb-6">What you can do:</h3>
            <div class="space-y-4 text-left">
                <div class="flex items-start space-x-3">
                    ...
                    <p class="text-neutral-700">Refresh the page and try again</p>
                </div>
                <div class="flex items-start space-x-3">
                    <div class="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                        <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-neutral-700">Clear your browser cache and cookies</p>
                </div>
                <div class="flex items-start space-x-3">
                    <div class="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                        <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-neutral-700">Try accessing the site from a different browser</p>
                </div>
                <div class="flex items-start space-x-3">
                    <div class="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                        <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-neutral-700">Contact our support team if the problem persists</p>
                </div>
            </div>
