...
<div class="min-h-screen bg-gradient-to-br from-neutral-50 to-primary-50 flex items-center justify-center">
    <div class="container mx-auto px-6 text-center">
        ...
        <div class="mb-8">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">{{ __('Page Not Found') }}</h2>
            <p class="text-xl text-neutral-600 max-w-2xl mx-auto leading-relaxed">
                {{ __('Oops! The page you\'re looking for doesn\'t exist. It might have been moved, deleted, or you entered the wrong URL.') }}
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-soft border border-neutral-100 p-8 max-w-4xl mx-auto">
            <h3 class="text-2xl font-bold text-neutral-900 mb-6">{{ __('Popular Pages') }}</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="/services" class="group block">
                    <div class="bg-neutral-50 rounded-xl p-6 transition-all duration-300 group-hover:bg-primary-50 group-hover:shadow-soft">
                        ...
                        <h4 class="text-lg font-semibold text-neutral-900 mb-2 group-hover:text-primary-600">{{ __('Our Services') }}</h4>
                        <p class="text-neutral-600 text-sm">{{ __('Explore our digital innovation solutions') }}</p>
                    </div>
                </a>
                ...
                <a href="/about" class="group block">
                    <div class="bg-neutral-50 rounded-xl p-6 transition-all duration-300 group-hover:bg-primary-50 group-hover:shadow-soft">
                        ...
                        <h4 class="text-lg font-semibold text-neutral-900 mb-2 group-hover:text-primary-600">{{ __('About Us') }}</h4>
                        <p class="text-neutral-600 text-sm">{{ __('Learn about our mission and values') }}</p>
                    </div>
                </a>
                ...
                <a href="/blog" class="group block">
                    <div class="bg-neutral-50 rounded-xl p-6 transition-all duration-300 group-hover:bg-primary-50 group-hover:shadow-soft">
                        ...
                        <h4 class="text-lg font-semibold text-neutral-900 mb-2 group-hover:text-primary-600">{{ __('Blog') }}</h4>
                        <p class="text-neutral-600 text-sm">{{ __('Read our latest insights and updates') }}</p>
                    </div>
                </a>
            </div>
        </div>
